...
<body>
	<div class="wrapper">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right">
								<li id="active" class="active"><a href="managecity">Manage
										City-Space</a></li>
								<li><a href="managereserve">Manage Account</a></li>
							</ul>
						</div>
						<div id="mouseout"></div>
						<!-- /.navbar-collapse -->
		...
		<div class="container">
			<div class="col-sm-3 left-part">
				<a href="managecity">Manage City</a> <a href="manageenterprise">Manage
					Enterprise</a> <a href="managebuilding">Manage Building</a> <a
					href="managefloor">Manage Floor</a> <a href="managespace">Manage
					Space</a>
			</div>
			<div class="col-sm-9 right-part">
				<div class="row">
					<h2>All Enterprise</h2>
					<button class="btn btn-default" data-toggle="modal"
						data-target="#addenterprise">Add an Enterprise</button>
				</div>
				<div class="row">
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<%-- 						<c:forEach var="i" begin="0" end="${sessionScope.enterpriselistsize}"
							step="1">

							<tr>
								<td><c:out value="${sessionScope.enterpriselist[i]}"></c:out></td>
							</tr>
						</c:forEach> --%>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="addenterprise">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Add an enterprise</h3>
				</div>
				<div class="modal-body">

					<form action="addenterprise.htm" method="post"
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label for="fullname">Enterprise Name</label> <input type="text"
									name="enterprisename" id="enterprisename-text"
									class="form-control" required />
							</div>
							<div class="errormsg">This enterprise has been added</div>
							<button type="submit" id="addenterprisebtn"
		...
		<div class="modal-dialog">
			<div class="modal-content action-success">
				...
				<div class="modal-header">
					...
					<h3 class="modal-title">Create Enterprise Succefully!</h3>
				</div>
