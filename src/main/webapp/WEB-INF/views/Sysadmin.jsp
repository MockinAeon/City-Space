			...
			<div class="col-sm-9 right-part">
				<div class="row">
					...
					<button class="btn btn-default" data-toggle="modal"
						data-target="#addcity">Add a City</button>
				</div>
				<div class="row">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Add a city</h3>
				</div>
				<div class="modal-body">

					<form action="addcity.htm" method="post" id="addcityform">
						<div class="form-group">
							<div class="form-group">
								<label for="fullname">City Name</label> <input type="text"
									name="cityname" id="cityname-text" class="form-control"
									required />
							</div>
							<div class="errormsg">This city has been added</div>
							<button type="submit" id="addcitybtn" class="btn btn-default">Add</button>
						</div>
					</form>
		...
		<div class="modal-dialog">
			<div class="modal-content action-success">
				...
				<div class="modal-header">
					...
					<h3 class="modal-title">Create City Succefully!</h3>
				</div>
