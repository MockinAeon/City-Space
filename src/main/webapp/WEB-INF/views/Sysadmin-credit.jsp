...
<body>
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="col-sm-9 right-part">
				<div class="row">
					<h2>CreditRole Account</h2>
					<button class="btn btn-default" data-toggle="modal"
						data-target="#addcredit">Add an Account</button>
				</div>
				<div class="row">
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<c:forEach var="credit" items="${sessionScope.creditlist}">
							<tr>
								<td>${credit.name}</td>
								<td>${credit.username}</td>
								<td>${credit.password}</td>
								<td>${credit.enterprisename}</td>
							</tr>
						</c:forEach>
					</table>
				</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="addcredit">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Add a credit account</h3>
				</div>
				<div class="modal-body">

					<form action="addcredit.htm" method="post" id="addcreditform">
						<div class="form-group">
							...
							<button type="submit" id="addcreditbtn" class="btn btn-default">Add</button>
						</div>
					</form>
