...
<body>
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="row">
				...
				<span class="tips using-error">You have to leave the space you are using now.</span>
					...
					<c:forEach var="reservation"
						...
						<tr>
							...
							<td><input type="radio" name="selectspace"
								value="${reservation.spacename.id}" /></td>
						</tr>
					</c:forEach>
				</table>
			</div>
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach var="subscription"
						...
						<tr>
							...
							<td><input type="radio" name="selectspace"
								value="${subscription.spacename.id}" /></td>
						</tr>
					</c:forEach>
				</table>
			</div>
	...
	<script src="resources/js/guest-home.js"></script>
</body>
