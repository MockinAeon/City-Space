					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right">
								<li><a
									href="checkrequest">Check Reserve
										Request</a></li>
								<li id="active" class="active"><a href="creditRolemanagecredit">Manage
										User Credit</a></li>
							</ul>
						</div>
						<div id="mouseout"></div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="button-part">
					<h2>User Credit</h2>
					<button class="btn btn-default creditedit-btn" id="addcredit-btn"
						data-toggle="modal" data-target=""> + </button>
					<button class="btn btn-default creditedit-btn" id="reducecredit-btn"
						data-toggle="modal" data-target=""> - </button>
				</div>
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach var="guest" items="${requestScope.guestlist}">
							<tr>
								<td>${guest.guestname}</td>
								<td>${guest.credit}</td>
								<td>${guest.reservationTimes}</td>
								<td>${guest.cancelTimes}</td>
								<td><input type="radio" name="selectguest"
								value="${guest.accountid}" /></td>
							</tr>
						</c:forEach>
				</table>
			</div>
				...
				<div class="modal-body">
					...
					<form action="addadvice.htm" method="post" id="addadviceform">
						<div class="form-group">
							...
							<button type="submit" id="addadvicebtn" class="btn btn-default">Add advice</button>
						</div>
					</form>
